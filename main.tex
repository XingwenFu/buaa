...
%=================================================================
% buaa基于ctexbook模板
% 论文样式参考自《北京航空航天大学研究生撰写学位论文的规定--2021年11月修订》
%======================
% 模板导入:
...
% 4. 参看示例模板 `main.tex` 及其中插入的各章节 `tex/*.tex` 熟悉模板结构和 $LaTeX$ 语法，撰写论文正文。
% 5. 在写公式时，请不要在公式之后加入额外的空行，避免空行所导致的公式与下一行距离过大的问题。
% 6. 在编译时，请使用xelatex进行编译，否则会出现页码不是五号宋体的问题。
% 7. 在写参考文献时，可以先选用GBT7714-2015.bst来查看缺少哪些关键内容，进行补全，如果存在某些内容找不到的问题，则可以使用GBT7714-2015-NoWarning.bst来不表示这些缺乏信息。
% 8. 在写表时，如果存在上下两个线加粗的需求，可以使用\toprule[], \midrule[] 和 \bottomrule[] 来加粗三线表的三条线。
% 9. 在写论文时，可根据tex文件里的注释信息来修改本文的密级，专硕学硕等内容。

%=================================================================
%!TEX program = xelatex
%在此修改 论文类型，密级，打印设置，系统类型，
\documentclass[professional,public,oneside,win, AutoFakeBold, doctor]{def/buaa}
...
\WarningFilter{latex}{Underfull \vbox{text}}
\WarningFilter{latex}{Underfull \hbox{text}}
%%=================================================================
% 论文题目及副标题-{中文}{英文}  
\Title{脑磁动态配准与源定位}{\LaTeX{} Template of Beihang University Thesis \BUAAThesis{}}
\Subtitle{版本 1.0}
...
\DateGraduate{03}{31}{2027}
\DateSubmit{01}{10}{2027}
\DateDefence{03}{01}{2027}
...
\Bib{def/GBT7714-2015.bst}{ref.bib}
...
This is \BUAAThesis{}, Happy TeXing! --- from Hanzx.
